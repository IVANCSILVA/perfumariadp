...
urlpatterns = [
    ...
    path('pagamentos/emis/callback/', views.pagamento_emis_callback, name='pagamento_emis_callback'),
    ...
    path('gestao/pagamentos/', views.gestao_pagamentos_config, name='gestao_pagamentos_config'),
