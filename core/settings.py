...
# ---------------------------------------------------------------------------
# Backend de consola por omissão — imprime o email no terminal do servidor.
# Para envios reais, definir EMAIL_BACKEND='django.core.mail.backends.smtp.EmailBackend'
# e configurar EMAIL_HOST/PORT/USER/PASSWORD/USE_TLS.
